...
import backgroundImage from '../../assets/images/backgrounds/splash.png'
...
const palette = {
  white: '#FFFFFF',
  black: '#000000',
  darkestNavy: '#06090c', // For vertical gradient

  darkMint: '#fca950',
  edgeMint: '#fcd650',
  darkAqua: '#000000',
  navyAqua: '#000000',
  navyAquaMiddle: '#ffffff', // For vertical gradient
  navyAquaDarker: '#000000', // For vertical gradient
  blueGray: '#ddaa00',
  gray: '#ffffff',
  lightGray: '#f2cb4b',
  mutedBlue: '#2F5E89',
